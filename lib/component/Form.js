...
class Form extends skynode_1.DomNode {
    constructor(swaper, chainId, isFrom = false) {
        ...
        this.append((0, skynode_1.el)(".chain", (0, skynode_1.el)(".icon", this.chainIcon = (0, skynode_1.el)("img", { height: "24" })), this.chainSelect = (0, skynode_1.el)("select", (0, skynode_1.el)("option", "Polygon", {
            value: "137",
        }), (0, skynode_1.el)("option", "Klaytn", {
            value: "8217",
        }), {
            change: () => {
